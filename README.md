...
## Quick start
1. Clone the repo
2. Create and activate Python environment, then install deps:

```bash
pip install -r requirements.txt
```

3. Open and run `project_code_full.ipynb` (set `RUN_*_TUNING` flags as needed)
4. Artifacts: `splits/*.csv`, `features/*.npz`, and `features/*_vectorizer.pkl`
