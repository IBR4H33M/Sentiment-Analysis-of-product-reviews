...
```
ml-service-ProductReview/
|
|-- app.py               <- Flask REST API server (loads models, handles requests)
|-- train_and_save.py    <- Full training pipeline (preprocessing, training, saving .pkl files)
